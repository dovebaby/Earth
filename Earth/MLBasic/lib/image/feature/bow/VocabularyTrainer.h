#ifndef VOCABULARY_TRAINER_H
#define VOCABULARY_TRAINER_H
...
std::string image_folder_path("D:\\MATLABCodes\\GlobeRecognition\\713Gloge\\America\\");
std::string image_list_file("name_list_file.txt");
...
int main(int argc, char* argv[])
{
    ...
    Ptr<DenseFeatureDetector> feature_detector = new DenseFeatureDetector();
    ...
    BOWKMeansTrainer bowtrainer(2); // 2 clusters
    bowtrainer.add(training_descriptors);
    cout << "clustering BOW features ..." << endl;
    Mat vocabulary = bowtrainer.cluster();

    cout << "Saving vocabulary_color_crop_2000.yml" << endl;
    FileStorage fs_vocabulary("vocabulary_color_surf_2.yml", FileStorage::WRITE);
